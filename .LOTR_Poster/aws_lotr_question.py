...
def lotr_question(event, context):
    questions = {
        ...
        100: "Do you prefer the LOTR movies or books?", #todo maybe get rid of this question
        101: "What are your opinions on the LOTR soundtrack?",
        102: "Which LOTR character would you want to be friends with?",
        103: "Do you prefer The Hobbit movies or books?", #todo maybe get rid of this question
    ...
    lookup = {
        ...
        208: "questions/char_CSLewisTolkien/",
        209: "None",
        210: "None",
        211: "None",
        212: "None",
