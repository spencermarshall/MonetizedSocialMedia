...
# updated LOTR questions as of 10/12/2025
...
def lotr_question(event, context):
    questions = {
        ...
        # todo maybe delete, 9 comments last time if low again then delete
        ...
        # here has young bilbo picture, maybe not applicable maybe most iconic
        ...
        # todo 2 comments, need to change something maybe add a few words or add emoji idk
    ...
    lookup = {
        ...
        10: "None",
        # "questions/char_galadriel/", todo i need to find out more about this character, i got multiple comments saying the image was the wrong person so i deleted all
