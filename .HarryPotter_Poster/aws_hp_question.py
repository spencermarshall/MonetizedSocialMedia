...
def HarryPotter_question(event, context):
    questions = {
        ...
        203: "What are your thoughts on the casting choices for the new Harry Potter TV series?",
        204: "Do you want to new HP show to follow the books almost exactly?",
        205: "What are your thoughts on the new HP show’s potential to explore more character backstories?",
