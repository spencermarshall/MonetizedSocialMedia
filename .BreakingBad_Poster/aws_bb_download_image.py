...
X_TARGET_USERNAME = 'Saulirony' # EDIT THIS AS NEEDED
# X_TARGET_USERNAME = 'OutContextWW'
BUCKET_NAME = 'bb.photos' # EDIT THIS AS NEEDED
...
def X_Download_Image_BB(event, context):
    tweets=None
    try:
